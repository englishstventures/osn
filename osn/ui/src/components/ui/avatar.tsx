...
const AvatarFallback: Component<ComponentProps<"span">> = (props) => {
  ...
  return (
    <span
      class={clsx(
        "base:bg-osn-surface-sunk base:text-osn-ink-secondary base:flex base:h-full base:w-full base:items-center base:justify-center base:text-osn-xs base:font-semibold",
        local.class,
      )}
      {...others}
    />

...
export function EmptyState(props: {
  ...
  return (
    <div class="base:flex base:flex-col base:items-center base:gap-2 base:rounded-osn-sm base:border base:border-dashed base:border-osn-hairline base:bg-osn-surface/30 base:p-8 base:text-center">
      <p class="base:font-osn-display base:text-osn-md base:font-light base:text-osn-ink">
        {props.title}
      </p>
      <Show when={props.description}>
        <p class="base:max-w-prose base:font-osn-body base:text-osn-sm base:leading-osn-relaxed base:text-osn-ink-secondary">
          {props.description}
        </p>
      </Show>

  ...
  return (
    <Popover placement={props.placement}>
      <PopoverTrigger
        ...
        class="base:bg-osn-surface-sunk base:text-osn-ink-secondary base:hover:bg-osn-surface-sunk/80 base:focus:ring-osn-focus base:ml-1 base:inline-flex base:h-4 base:w-4 base:items-center base:justify-center base:rounded-full base:text-[10px] base:font-semibold base:focus:ring-2 base:focus:outline-none"
      >
        {props.glyph ?? "?"}
      </PopoverTrigger>

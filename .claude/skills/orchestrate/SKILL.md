...
- Match repo conventions (`AGENTS.md`, the product's `wiki/apps/<product>-development.md`), add the changeset, follow the observability rules, write tests — TDD where there is logic.

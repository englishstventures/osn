...
These files are **not used by this repo.** They belong to `englishstventures/osn-tracker`, the private
...
gh api repos/englishstventures/osn-tracker/contents/.github/ISSUE_TEMPLATE/review-finding.yml \
  ...
  -f sha="$(gh api repos/englishstventures/osn-tracker/contents/.github/ISSUE_TEMPLATE/review-finding.yml --jq .sha 2>/dev/null)"
```

      ...
      <Show when={registry()}>
        ...
        >
          <div class="mx-auto max-w-[540px] text-center md:max-w-[46rem]">
            ...
            <Show when={body()}>
              {(text) => (
                <p class="font-body text-text-muted text-osn-base leading-osn-normal mx-auto mb-8 max-w-[34rem] break-words whitespace-pre-line">
                  {text()}
                </p>
              )}
            </Show>
            ...
            <Show when={availabilityCopy()}>
              {(copy) => (
                <p
                  ...
                  class="font-body text-text-muted text-osn-xs tracking-osn-widest mt-4 uppercase"
                >
                  {copy()}
                </p>
              )}

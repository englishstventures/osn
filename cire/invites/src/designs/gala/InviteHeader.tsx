          ...
          <div class="relative flex min-h-dvh flex-col items-start justify-end bg-[radial-gradient(ellipse_at_center,var(--invite-scrim-from)_0%,var(--invite-scrim-to)_100%)] px-[max(1.5rem,env(safe-area-inset-left))] pt-[max(1.5rem,env(safe-area-inset-top))] pb-[max(2.5rem,env(safe-area-inset-bottom))]">
            ...
            >
              <Show
                ...
                fallback={
                  <span class="font-display text-gold leading-osn-none max-w-full pb-1 text-left text-[calc(clamp(2.75rem,9vw,6.5rem)*var(--invite-heading-scale,1))] [font-weight:var(--invite-heading-weight,300)] break-words [font-style:var(--invite-heading-style,normal)] select-none">
                    You're Invited
                  </span>
                }
              >
                {(title) => (
                  // leading-osn-none + pb-1, never leading-none: at 6.5rem a name
              ...
              <Show when={hero()?.subtitle}>
                {(subtitle) => (
                  ...
                  <div class="flex flex-col items-start gap-3">
                    ...
                    <p class="font-body text-gold-ink text-osn-sm tracking-osn-ultra max-w-full text-left break-words uppercase">
                      {subtitle()}
                    </p>
                  </div>
                )}

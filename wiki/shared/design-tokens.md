...
[[wiki/shared/component-library]] §Overriding a `Modal` default, which is
...
| `@cire/ui`              | cire's house components — see [[wiki/shared/component-library]] for why two layers rather than one                                                                                                                                                              |

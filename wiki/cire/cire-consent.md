...
says "Data already sent can't be recalled.", which is what `/privacy` says:
neither the unmount nor the reload takes back what a vendor received or
stored. `ConsentBanner.test.tsx` pins both sentences.

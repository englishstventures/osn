...
- 21f3cff: `Toaster` can raise itself into the top layer
  ...
  toast to show, so it enters the top layer _after_ any dialog that was already
...
- ac41e37: `Toaster` can raise itself into the top layer

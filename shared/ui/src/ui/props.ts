 ...
 * that spreads its rest props onto an element therefore accepts, and
 * type-checks, `<Notice innerHTML={vendorName} />` — which reads at the call
 * site like ordinary prop passing and is a script tag.
 *

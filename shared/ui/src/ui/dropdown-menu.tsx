  ...
  return (
    <KobalteDropdownMenu.Portal>
      <KobalteDropdownMenu.Content
        class={clsx(
          "base:bg-ui-surface-raised base:text-ui-ink base:border-border base:z-50 base:min-w-[8rem] base:rounded-ui-md base:border base:p-1 base:shadow-md base:outline-none",

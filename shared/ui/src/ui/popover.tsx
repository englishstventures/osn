  ...
  return (
    <KobaltePopover.Portal>
      <KobaltePopover.Content
        class={clsx(
          "base:bg-ui-surface-raised base:text-ui-ink base:border-ui-hairline base:z-50 base:w-60 base:rounded-ui-md base:border base:p-2 base:text-ui-sm base:shadow-md base:outline-none",

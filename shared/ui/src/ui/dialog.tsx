  ...
  return (
    <DialogPortal>
      ...
      <KobalteDialog.Content
        class={clsx(
          "base:bg-ui-surface base:border-border base:fixed base:top-[50%] base:left-[50%] base:z-50 base:w-full base:max-w-lg base:translate-x-[-50%] base:translate-y-[-50%] base:rounded-ui-lg base:border base:shadow-xl base:focus:outline-none sm:base:rounded-ui-lg",

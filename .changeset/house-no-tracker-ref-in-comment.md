...
A stable reference is the encouraged form, not a banned one: a wiki page by repo path, or a public `englishstventures/osn` issue. Only the private tracker's IDs and the finding tags are out, and a bare `#123` was never matched.

...
they are now `lucide-solid` icons, imported one at a time: a dashboard for
Overview, a calendar for Events, a checklist, a wallet for Budget, a shopfront
for Vendors, a gift box for Registry, people for Guests, an open envelope for
Invite and a gear for Settings.
...
The bundle grows by 2888 bytes gzip, and the `cire/host` size budget is
re-baselined to 252534 bytes.
